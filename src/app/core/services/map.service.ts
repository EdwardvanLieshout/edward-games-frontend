...
export class MapService {
  ...
  private worldMap: ITile[][] = [
    ...
    [
      ...
      { tileType: this.tileEnum.WALL, tex0: this.texEnum.GREENGRID },
      { tileType: this.tileEnum.WALL, tex0: this.texEnum.STONEWALL },
      { tileType: this.tileEnum.WALL, tex0: this.texEnum.GREENGRID },
      { tileType: this.tileEnum.WALL, tex0: this.texEnum.GREENGRID },
      { tileType: this.tileEnum.WALL, tex0: this.texEnum.GREENGRID },
      { tileType: this.tileEnum.WALL, tex0: this.texEnum.GREENGRID },
    ...
    [
      ...
      {
        tileType: this.tileEnum.FLOOR,
        tex0: this.texEnum.DISCORED1,
        tex1: this.texEnum.PLAIN,
        room: RoomTypeEnum.SOCIAL,
      },
      {
        tileType: this.tileEnum.FLOOR,
        tex0: this.texEnum.DISCOGREEN1,
        tex1: this.texEnum.PLAIN,
        room: RoomTypeEnum.SOCIAL,
      },
      {
        tileType: this.tileEnum.FLOOR,
        tex0: this.texEnum.DISCOPURPLE1,
        tex1: this.texEnum.PLAIN,
        room: RoomTypeEnum.SOCIAL,
      },
      {
        tileType: this.tileEnum.FLOOR,
        tex0: this.texEnum.DISCOBLUE1,
        tex1: this.texEnum.PLAIN,
        room: RoomTypeEnum.SOCIAL,
      },
      {
    ...
    [
      ...
      { tileType: this.tileEnum.WALL, tex0: this.texEnum.GREENGRID },
      { tileType: this.tileEnum.WALL, tex0: this.texEnum.GREENGRID },
      { tileType: this.tileEnum.WALL, tex0: this.texEnum.HITECH },
      {
        tileType: this.tileEnum.FLOOR,
        tex0: this.texEnum.HITECH,
        tex1: this.texEnum.HITECH,
        room: RoomTypeEnum.GADGETS,
      },
      {
        tileType: this.tileEnum.FLOOR,
