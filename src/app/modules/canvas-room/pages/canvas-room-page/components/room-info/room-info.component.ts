...
export class RoomInfoComponent implements OnInit, OnDestroy {
  ...
  public infoDictionary = {
    'Main Zone': {
      ...
      content:
        'Walk around using the arrow keys to explore the surrounding areas.',
    },
    'Authors Room': {
      title: 'Edward van Lieshout',
      content:
        'In this room you can find more info about Edward van Lieshout, the maker of this website.',
    },
    'Adventure Gate': {
      title: 'W.I.P.',
      content:
        'This area is under construction for now. Please come back later',
    },
    'Hall of Gadgets': {
      title: 'W.I.P.',
      content:
